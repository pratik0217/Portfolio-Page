...
export default function About(props) {
  return (
    <div id='about' className='container flex flex-col gap-10'>
      <div id="about-info" className='flex flex-col gap-10'>
        <div id="heading-text" className='text-8xl font-bold'>
          <h1>About me</h1>
        </div>

        <div id="about-info" className='flex flex-col gap-5 w-[70%]'>
          <p>Results-driven <mark> React Frontend Developer </mark> focused on building user-friendly interfaces.</p>
          <p>Strong expertise in web technologies, software troubleshooting, and system management. Skilled in developing responsive, user-friendly applications using modern tools and frameworks. Adept at analyzing technical issues, optimizing performance, and delivering reliable solutions. Experienced in working with cross-functional teams, following best coding practices, and maintaining high-quality standards. Known for quick learning, strong problem-solving abilities, and a commitment to continuous improvement in a fast-paced IT environment.</p>
        </div>
      </div>

      <div id="education-selection" className='flex flex-col gap-5'>
        <div id="education-heading" className='text-5xl font-medium'>
          <h1>Education</h1>
        </div>

        <div id="education-info" className='flex flex-col gap-10'>
          <div id="engineering" className='flex bg-(#693B93) flex-row-reverse justify-between items-center pt-6 pb-6'>
          ...
          <div id="high-school" className='flex justify-between items-center pt-6 pb-6'>
      ...
      <div id="experience-selection" className='flex flex-col gap-10'>
        <div id="experience-heading" className='text-5xl font-medium'>
          <h1>Experience</h1>
        </div>

        <div id="experience-info" className='flex flex-col gap-5'>
          <div id="experience-company" className='flex flex-col-reverse gap-2.5'>
            <div id="company-name">
          ...
          <div id="experience-description" className='w-[90%] m-auto'>
